  ...
  return (
    <div className="template-parent">
      ...
      <div className="objective mt-5">
       <h3 style={{backgroundColor:"gray",padding:8,textAlign:"center"}}><b>Objective</b></h3>
       <hr/>
       <p>{user.carrier}</p>
      </div>
      <div className="education mt-5">
      <h3  style={{backgroundColor:"gray",padding:8,textAlign:"center"}}><b>Education</b></h3>
       <hr/>
      ...
      <h3  style={{backgroundColor:"gray",padding:8,textAlign:"center"}} ><b>Experience</b></h3>
       <hr/>
      ...
      <h3  style={{backgroundColor:"gray",padding:8,textAlign:"center"}}><b>Projects</b></h3>
       <hr/>
      ...
      <h3  style={{backgroundColor:"gray",padding:8,textAlign:"center"}}><b>Skills</b></h3>
       <hr/>
